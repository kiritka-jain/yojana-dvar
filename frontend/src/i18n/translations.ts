...
export const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    incomeTierBpl: "BPL / Antyodaya (₹0)",
    incomeTierBplDesc: "Antyodaya or BPL ration card / Zero income",
    incomeTierLow: "Up to ₹1.5 Lakh / Year",
    incomeTierLowDesc: "Annual income below ₹1.5 Lakh",
    incomeTierMid: "₹1.5 Lakh – ₹3 Lakh / Year",
    incomeTierMidDesc: "Annual income between ₹1.5L – ₹3L",
    incomeTierHigh: "Above ₹3 Lakh / Year",
    incomeTierHighDesc: "Annual income above ₹3 Lakh",
  ...
  hi: {
    ...
    incomeTierBpl: "बीपीएल / अंत्योदय (₹0)",
    incomeTierBplDesc: "अंत्योदय या बीपीएल राशन कार्ड / शून्य आय",
    incomeTierLow: "₹1.5 लाख वार्षिक तक",
    incomeTierLowDesc: "पारिवारिक वार्षिक आय ₹1.5 लाख से कम",
    incomeTierMid: "₹1.5 लाख से ₹3 लाख वार्षिक",
    incomeTierMidDesc: "पारिवारिक वार्षिक आय ₹1.5L से ₹3L",
    incomeTierHigh: "₹3 लाख वार्षिक से अधिक",
    incomeTierHighDesc: "पारिवारिक वार्षिक आय ₹3 लाख से अधिक",
